...
class IdWorker {
    ...
    nextId () {
        ...
        return timestampGap.shiftLeft(this.timestampLeftShift).or((this.datacenterId << this.datacenterIdShift) |
            (this.workerId << this.workerIdShift) | this.sequence).toNumber();
    }
